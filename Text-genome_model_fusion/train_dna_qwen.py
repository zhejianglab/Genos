...
def main(args: ArgumentParser):
    ...
    # Setup directories
    run_name = f"{args.project_name}-{args.dataset_type}-{args.text_model_name.split('/')[-1]}" 
...
if __name__ == "__main__":
    ...
    parser.add_argument("--project_name", type=str, default="nt-500m-qwen3-1.7b-finetune")
